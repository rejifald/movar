...
Stop the conceal curtain rendering two different collapse tiers on cards a reader sees as the same size, and fix the overflow the old fold could not express.
