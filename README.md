...
![content.js: 30 KB (source graph)](https://img.shields.io/badge/content.js-30_KB_%28source_graph%29-blue)
...
- **Lines of code** `29.9k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
