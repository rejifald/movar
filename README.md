...
![content.js: 38 KB (source graph)](https://img.shields.io/badge/content.js-38_KB_%28source_graph%29-blue)
...
- **Lines of code** `41.8k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
