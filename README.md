...
![coverage: 96% lines · 90% branches](https://img.shields.io/badge/coverage-96%25_lines_%C2%B7_90%25_branches-brightgreen)
![content.js: 44 KB (source graph)](https://img.shields.io/badge/content.js-44_KB_%28source_graph%29-blue)
...
- **Lines of code** `56.3k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
- **Suppressions** `46 eslint-disable · 23 fallow-ignore` — inline lint / complexity opt-outs across the tree; the fallow-ignore set is budgeted and each is justified at the call site.
