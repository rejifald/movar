...
![coverage: 93% lines · 86% branches](https://img.shields.io/badge/coverage-93%25_lines_%C2%B7_86%25_branches-green)
...
- **Coverage** `93% lines · 86% branches` — Vitest (v8) line and branch coverage, aggregated across the test-bearing workspace projects weighted by size; snapshotted by `pnpm metrics`.
