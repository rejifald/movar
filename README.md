...
![code health: 83 (B)](https://img.shields.io/badge/code_health-83_%28B%29-green)
![coverage: 94% lines · 87% branches](https://img.shields.io/badge/coverage-94%25_lines_%C2%B7_87%25_branches-green)
![content.js: 34 KB (source graph)](https://img.shields.io/badge/content.js-34_KB_%28source_graph%29-blue)
...
- **Code health** `83 (B)` — fallow maintainability score, 0-100 with an A-F grade, over complexity, duplication, dead code, and churn; refreshed by `pnpm metrics`.
...
- **Lines of code** `31.4k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
