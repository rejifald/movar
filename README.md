...
![coverage: 94% lines · 88% branches](https://img.shields.io/badge/coverage-94%25_lines_%C2%B7_88%25_branches-green)
...
- **Coverage** `94% lines · 88% branches` — Vitest (v8) line and branch coverage, aggregated across the test-bearing workspace projects weighted by size; snapshotted by `pnpm metrics`.
