...
![content.js: 41 KB (source graph)](https://img.shields.io/badge/content.js-41_KB_%28source_graph%29-blue)
...
- **Lines of code** `43.1k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
