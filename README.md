...
![coverage: 95% lines · 88% branches](https://img.shields.io/badge/coverage-95%25_lines_%C2%B7_88%25_branches-green)
![content.js: 40 KB (source graph)](https://img.shields.io/badge/content.js-40_KB_%28source_graph%29-blue)
...
- **Lines of code** `43.0k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
- **Suppressions** `43 eslint-disable · 24 fallow-ignore` — inline lint / complexity opt-outs across the tree; the fallow-ignore set is budgeted and each is justified at the call site.
