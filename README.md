...
![content.js: 37 KB (source graph)](https://img.shields.io/badge/content.js-37_KB_%28source_graph%29-blue)
...
- **Lines of code** `39.0k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
- **Suppressions** `42 eslint-disable · 25 fallow-ignore` — inline lint / complexity opt-outs across the tree; the fallow-ignore set is budgeted and each is justified at the call site.
