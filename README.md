...
![coverage: 95% lines · 87% branches](https://img.shields.io/badge/coverage-95%25_lines_%C2%B7_87%25_branches-green)
...
- **Coverage** `95% lines · 87% branches` — Vitest (v8) line and branch coverage, aggregated across the test-bearing workspace projects weighted by size; snapshotted by `pnpm metrics`.
