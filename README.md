...
![coverage: 89% lines · 82% branches](https://img.shields.io/badge/coverage-89%25_lines_%C2%B7_82%25_branches-green)
...
- **Coverage** `89% lines · 82% branches` — Vitest (v8) line and branch coverage, aggregated across the test-bearing workspace projects weighted by size; snapshotted by `pnpm metrics`.
