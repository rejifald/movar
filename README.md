...
![code health: 85 (A)](https://img.shields.io/badge/code_health-85_%28A%29-brightgreen)
![coverage: 93% lines · 86% branches](https://img.shields.io/badge/coverage-93%25_lines_%C2%B7_86%25_branches-green)
![content.js: 31 KB (source graph)](https://img.shields.io/badge/content.js-31_KB_%28source_graph%29-blue)
...
- **Code health** `85 (A)` — fallow maintainability score, 0-100 with an A-F grade, over complexity, duplication, dead code, and churn; refreshed by `pnpm metrics`.
...
- **Lines of code** `30.2k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
