...
![coverage: 95% lines · 89% branches](https://img.shields.io/badge/coverage-95%25_lines_%C2%B7_89%25_branches-green)
![content.js: 43 KB (source graph)](https://img.shields.io/badge/content.js-43_KB_%28source_graph%29-blue)
...
- **Lines of code** `46.2k` — TypeScript under `apps/` + `packages/`, tests excluded; snapshotted by `pnpm metrics`.
- **Suppressions** `44 eslint-disable · 23 fallow-ignore` — inline lint / complexity opt-outs across the tree; the fallow-ignore set is budgeted and each is justified at the call site.
