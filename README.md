...
<sub>Generated by `pnpm gen:readme` from committed sources; the code-health score is snapshotted by `pnpm metrics`. Badges flag the self-explanatory metrics — the list below is the full legend.</sub>
