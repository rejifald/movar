...
> Тримайте інтернет вашою мовою. Мовар коригує Google, Bing, DuckDuckGo та YouTube, щоб результати показувались вибраною мовою.
...
> • Мовар автоматично застосовує виправлення під час перегляду.
> • Відкрийте спливне вікно, щоб побачити стан Мовара для сторінки, яку ви переглядаєте, призупинити Мовар для поточного сайту або перейти до налаштувань.
>
> Приватність
