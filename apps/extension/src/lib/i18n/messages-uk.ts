...
export const messagesUk: Messages = {
  ...
  options: {
    ...
    pageContent: {
      ...
      intro:
        'Коли увімкнено, Movar фільтрує вміст заблокованими мовами — приховує пункти в перемикачах мов на сайтах і ховає картки вмісту (наприклад, відео на YouTube) заблокованою мовою. Обери, чи лишати приховані картки за завісою, чи прибирати зовсім. Вимкнено за замовчуванням; увімкни, щоб сторінка була охайнішою.',
