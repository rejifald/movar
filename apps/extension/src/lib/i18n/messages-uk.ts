...
export const messagesUk: Messages = {
  ...
  contentToggle: {
    ...
    mode: {
      curtain: 'Режим завіси: заблоковані картки лишаються закритими, доки їх не відкрити',
      hide: 'Режим без завіси: заблоковані елементи прибираються повністю',
    },
  },
      ...
      concealMode: {
        ...
        options: {
          curtain: {
            label: 'Завіса',
            description:
              'Закривати заблоковані картки завісою, щоб їх можна було відкрити за потреби; пункти в перемикачах прибираються.',
          },
          hide: {
            label: 'Без завіси',
            description: 'Прибирати заблоковані пункти й картки без додаткового шару.',
          },
        },
      },
    },
