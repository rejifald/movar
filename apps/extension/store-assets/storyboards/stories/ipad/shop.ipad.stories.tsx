...
import { IPAD_13, SHOP, renderScene } from '../../scenes/portrait-diptych-scenes';

/** iPad App Store screenshot #7 — Ukrainian online shop (iPad 13″). */
const meta = {
  title: 'Marketplace/IPadScreenshots/Shop',
...
export const English: Story = { render: () => renderScene(IPAD_13, 'en', SHOP) };
export const Ukrainian: Story = { render: () => renderScene(IPAD_13, 'uk', SHOP) };
