...
import { IPAD_13, YOUTUBE, renderScene } from '../../scenes/portrait-diptych-scenes';

/** iPad App Store screenshot #6 — YouTube recommendations (iPad 13″). */
const meta = {
  title: 'Marketplace/IPadScreenshots/Youtube',
...
export const English: Story = { render: () => renderScene(IPAD_13, 'en', YOUTUBE) };
export const Ukrainian: Story = { render: () => renderScene(IPAD_13, 'uk', YOUTUBE) };
