...
export const messagesUk: HostMessages = {
  ...
  audit: {
    ...
    confirm: {
      ...
      body: (host) =>
        `Мовар кілька разів звернеться до ${host} — по разу на кожну мовну вподобу — просто з цього пристрою.`,
      points: [
        'У запитах немає нічого про вас: ні куків, ні облікового запису, ні ідентифікаторів.',
        'Мовар називає себе в кожному запиті, тож власник сайту побачить його у своїх логах.',
        'Сервера Мовара між вами немає — запити йдуть із цього пристрою просто на той сайт.',
      ],
    ...
    matrix: {
      ...
      intro: 'Та сама адреса, запитана кілька разів. Змінювалася лише мовна вподоба.',
      noPreference: 'без вподоби',
      noAnswer: 'не відповів',
      undeclared: 'мову не заявлено',
      openSite: 'Відкрити сайт у Safari',
      openSiteNote: 'Покаже сайт таким, який він зараз, — не таким, як під час перевірки.',
    },
    privacy: {
      title: 'Як це працює',
      items: [
