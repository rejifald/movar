...
![Стовпчикова діаграма мов клієнтів Steam за липень 2026: російська третя з 9,30%, українська п'ятнадцята з 0,70%, одразу попереду італійської з 0,63%](../../apps/marketing/src/content/blog/assets/steam-languages.svg)
...
![Схема шести сигналів визначення мови сторінки, від найнадійнішого до найслабшого: перемикач мов, атрибут html lang, піддомен, сегмент шляху, self-hreflang, текст сторінки](../../apps/marketing/src/content/blog/assets/signal-ladder.svg)
