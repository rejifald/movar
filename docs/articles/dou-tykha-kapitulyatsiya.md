...
![Стовпчикова діаграма мов клієнтів Steam за липень 2026: російська третя з 9,30%, українська п'ятнадцята з 0,70%, одразу попереду італійської з 0,63%](assets/steam-languages.png)
...
![Схема шести сигналів визначення мови сторінки, від найнадійнішого до найслабшого: перемикач мов, атрибут html lang, піддомен, сегмент шляху, self-hreflang, текст сторінки](assets/signal-ladder.png)
