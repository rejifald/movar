...
| Picker mark    | In-row / badge label            | ≤ 3 words             | state                    | _"Movar: hidden"_ / «Мовар: приховано»                                                                                                 |
| Picker mark    | Hover / screen-reader sentence  | 1 sentence            | protect                  | _"Movar hid the {endonym} option — click to show"_                                                                                     |
...
| _has the right to_, _is entitled to_ (of a site or server) / _має право_                                         | Grants a site an entitlement it does not have. Nothing enforces the header — the site simply ignores it. Motive framing where a mechanism is meant (§1.6) | _may_, _nothing forces it to_ / _може_, _ніщо не змушує_                                                                                                                         |
