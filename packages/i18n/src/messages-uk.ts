...
export const messagesUk: Messages = {
  ...
  onboarding: {
    ...
    intro:
      'Movar тримає кожну сторінку вашою мовою. Для цього він перевіряє сторінки, які ви відкриваєте, — нижче показано, як це увімкнути.',
    ...
    access: {
      chromium: {
        ...
        body: (browserName) =>
          `Movar перевіряє мову кожної сторінки, а потім перемикає її на вашу. Натисніть кнопку нижче, щоб дозволити це в ${browserName}.`,
      },
      firefox: {
    ...
    permission: {
      granted: 'Movar перемикає сторінки на вашу мову.',
      missing:
        'Movar потрібен доступ до сторінок, щоб перемикати їх на вашу мову — надайте доступ нижче.',
