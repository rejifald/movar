...
export const messagesUk: Messages = {
  ...
  onboarding: {
    ...
    intro:
      'Movar тримає кожну сторінку вашою мовою. Для цього він читає вміст кожної сторінки, щоб визначити її мову, — нижче показано, як це увімкнути.',
    ...
    access: {
      chromium: {
        ...
        body: (browserName) =>
          `Movar читає вміст кожної сторінки, щоб визначити її мову, а потім перемикає її на вашу. Натисніть кнопку нижче, щоб дозволити це в ${browserName}.`,
      },
      firefox: {
    ...
    permission: {
      granted: 'Movar може читати вміст сторінки.',
      missing: 'Movar потрібен дозвіл читати вміст сторінки — надайте доступ нижче.',
