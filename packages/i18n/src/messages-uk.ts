  ...
  onboarding: {
    ...
    access: {
      ...
      safari: {
        ...
        body: 'У налаштуваннях Safari відкрийте «Розширення», виберіть Мовар і оберіть «Дозволити на всіх сайтах».',
      },
      safariIos: {
        title: 'Дозвольте на всіх сайтах',
        body: 'У «Налаштуваннях» відкрийте «Програми» → Safari → «Розширення» → Мовар і встановіть «Усі сайти» на «Дозволити».',
      },
    },
    enable: {
      safari: {
        title: 'Увімкніть Мовар',
        body: 'Відкрийте налаштування Safari, перейдіть до «Розширень» і увімкніть Мовар.',
      },
      safariIos: {
        title: 'Увімкніть Мовар',
        body: 'У «Налаштуваннях» відкрийте «Програми» → Safari → «Розширення» і увімкніть Мовар.',
      },
    },
    permission: {
