  ...
  onboarding: {
    ...
    access: {
      chromium: {
        ...
        body: (browserName) =>
          `Movar читає кожну сторінку, щоб визначити її мову. Відкрийте меню Movar у ${browserName} і виберіть доступ «На всіх сайтах».`,
      },
      firefox: {
        title: 'Збережіть доступ до всіх сайтів',
        body: 'Firefox надає Movar доступ до всіх сайтів під час встановлення. Якщо ви його вимкнули, увімкніть «Доступ до ваших даних для всіх сайтів» у about:addons.',
      },
      safari: {
    ...
    permission: {
      ...
      missing: 'Movar ще не читає сторінки — крок вище надає доступ.',
