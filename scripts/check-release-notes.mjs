...
const version =
  ...
  JSON.parse(readFileSync(nodePath.resolve(repoRoot, 'apps/extension/package.json'), 'utf8'))
    .version;

const notes = parseReleaseNotes(readFileSync(nodePath.resolve(repoRoot, NOTES), 'utf8'));
const problems = [];
